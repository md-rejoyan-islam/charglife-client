  ...
  return (
    <>
      ...
      <div className="w-72 rounded-lg bg-white shadow-lg pt-4 pb-6 px-6 text-center">
        {/* Returning customer */}
        <p className="text-sm font-medium text-[darkgray]">Returning Customer&nbsp;?</p>

        {/* Sign‑in button */}
        <Link href={"/account/login"} className="mt-3 inline-block rounded bg-yellow-400 px-5 py-1.5 text-sm font-semibold text-gray-900 hover:bg-yellow-300 focus:outline-none">
          Sign in
        </Link>
        ...
        <Link href={"/account/register"} className="mt-1 text-sm font-medium text-gray-800 hover:underline">
          Register
        </Link>
      </div>
    </div>
